...
app = Flask(__name__)
app.secret_key = "paviiii"  # Replace with your own secret key, needed for session management
...
def generate_data(N, mu, beta0, beta1, sigma2, S):
    ...
    plt.hist(slopes, bins=20, alpha=0.6, color="#4169E1", label="Slopes")  # Royal Blue for slopes
    plt.hist(intercepts, bins=20, alpha=0.6, color="#DAA520", label="Intercepts")  # Goldenrod for intercepts
...
def hypothesis_test():
    ...
    # TODO 11: If p_value is very small, set fun_message to a fun message
    if p_value <= 0.0001:
